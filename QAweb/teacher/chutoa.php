...
<body>
	<div class="newbody" >
		...
		<div  class="newbody3" style="border-radius: 5px ;overflow: auto" >
			...
			<div style="float: right; margin-bottom: 5px ; margin-right: 150px;margin-top: 0px">
				<button style="height: 30px ;width: 100px; background-color:#2EFE9A ; border-radius: 5px" id="statistical-01" ;>thong ke</button>
			</div>	
		</div>	
		<div  class="newbody4" style="border-radius: 5px ;overflow: auto" >
			...
			<div  style="float: right; margin-bottom: 5px ; margin-right: 150px;margin-top: 0px">
				<button style="height: 30px ;width: 100px; background-color:#2EFE9A ; border-radius: 5px" id="statistical-02" ;>thong ke</button>
			</div>	
		</div>	
	</div>
</body>
