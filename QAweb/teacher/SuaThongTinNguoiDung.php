...
<body> 
	...
	<div  class="dangnhap"  >
		...
		<div class="newbody" style="background-color: #FAFAFA">
					...
					<form class="form">
						...
						<div class="thongtin" style="margin-top: 30px">
							<div class="form-group" >
								...
								<h5 id="tendangnhap" > Nguyễn văng a</h5>
							</div>
							...
							<div class="form-group">
								...
								<input type="text" id="name" name="hoten" value="old_name" onblur="chuanhoa()" ></br>
							</div>
							<div class="form-group">
								<label>
									<h4> Email :</h4>
								</label>
								<input type="text" value="old_email" id="email">
							</div>
						</div>
					</form>
				</div>
			...
			<input  id="submit"  type="image" style="margin: 5px 	100px " src="icon.png" alt="SUBMIT" class="imge1"  onclick="error()" />
				<!--<img src="icon.png" >-->
		</div>
	</div>
</body>
